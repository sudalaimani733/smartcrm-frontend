...
export default function DealForm({ customers, users, onSubmit, onCancel }) {
  const [form, setForm] = useState({ title: '', customerId: '', value: '', expectedCloseDate: '', assignedToId: '' });

  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ ...form, value: parseFloat(form.value), assignedToId: form.assignedToId || null });
  };
